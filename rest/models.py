...
class Hero(models.Model):
    ...
    name = models.CharField(max_length=1024, null=False, blank=False, verbose_name="Имя героя")
    intelligence = models.IntegerField(blank=True, null=True, verbose_name="Интеллект героя")
